...
<div class="page-wrapper">
    ...
    <div>
            ...
            <div class="row restaurant_payout_create">
                ...
                <div class="restaurant_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row col-12">
                            <label for="special_request control-label">Type</label>
                            <input class="form-control special_request" id="book_type" type="text" placeholder="" disabled>
                        </div>
        ...
        <div class="form-group col-12 text-center btm-btn">
            ...
            <a href="{{route('restaurants.booktable',$id)}}" class="btn btn-default"><i
