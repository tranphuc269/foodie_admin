        ...
        $(document).ready(async function () {
            ...
            ref.get().then(async function (snapshots) {
                ...
                if (user.hasOwnProperty('shippingAddress')) {
                    if (user.shippingAddress.hasOwnProperty('line1') && user.shippingAddress.line1) {
                        address = user.shippingAddress.line1;
                    }
                    if (user.shippingAddress.hasOwnProperty('line2') && user.shippingAddress.line2) {
                        if (address != "") {
                            address = address + ", ";
                        }

                        address = address + user.shippingAddress.line2;
                    }
                    if (user.shippingAddress.hasOwnProperty('city') && user.shippingAddress.city) {
                        if (address != "") {
                            address = address + ", ";
                        }

                        address = address + user.shippingAddress.city;
                    }
                    if (user.shippingAddress.hasOwnProperty('country') && user.shippingAddress.country) {
                        if (address != "") {
                            address = address + ", ";
                        }

                        address = address + user.shippingAddress.country;
                    }
                    if (user.shippingAddress.hasOwnProperty('postalCode') && user.shippingAddress.postalCode) {
                        if (address != "") {
                            address = address + ", ";
                        }

                        address = address + user.shippingAddress.postalCode;
                    }
                }
                ...
                if (address != "") {
                    ...
                    $('.address').html("{{trans('lang.not_mentioned')}}");
